    ...
    define('runtime/html5/filepaste', [
        ...
        return Html5Runtime.register('FilePaste', {
            ...
            _pasteHander: function(e) {
                ...
                var t, r, i, o, a, s = [],
                    u = this.getRuid();
                for (e = e.originalEvent || e, t = e.clipboardData.items, o = 0, a = t.length; a > o; o++)
                    r = t[o], "file" === r.kind && (i = r.getAsFile()) && s.push(new File(u, i));
                ...
                /*if (!allowed.length) {
                    debugger;
                    var htmltext = e.clipboardData.getData("Text");
                    $('.One:visible div.consh').find(".edit").html(htmltext);
                    editBlur();
                    insertHTMLByCommand($('.One:visible div.consh'),htmltext);
                    //alert(htmltext);
                    return;
                }*/
